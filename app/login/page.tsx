            ...
            <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-4 w-full">
                            <Button
                                ...
                                className="w-full text-lg shadow-orange-500/20 shadow-xl text-white bg-gradient-to-r from-orange-500 to-red-600 border-none"
                            >
                                Registrarme
                ...
                {view === "login" && (
                    <motion.div
                        ...
                        className="w-full"
                    >
                        <Card className="glass-card p-8 border-orange-500/20">
                            <div className="flex flex-col items-center mb-6">
                                <KeyRound className="w-12 h-12 text-orange-500 mb-4" />
                            ...
                            <form onSubmit={handleLogin} className="space-y-4">
                                <div className="space-y-2 text-left">
                                    ...
                                    <Input
                                        ...
                                        className="focus-visible:ring-orange-500 text-white placeholder:text-zinc-600"
                                    />
                                </div>

                                {error && <p className="text-red-500 text-sm">{error}</p>}

                                <Button type="submit" className="w-full mt-4 text-white font-semibold shadow-lg shadow-orange-500/20 bg-orange-600 hover:bg-orange-700 border-none transition-all">
                                    Ingresar
                                </Button>

                                <p
                                    className="text-xs text-zinc-500 mt-4 cursor-pointer hover:text-orange-400 transition-colors"
                    ...
                    >
                        <Card className="glass-card p-8 border-orange-500/20">
                            <div className="flex flex-col items-center mb-6">
                                ...
                                <p className="text-zinc-400 text-sm mt-1">Únete a nuestra parrilla exclusiva</p>
                            </div>
